 ...
 */
cf_rv_t CF_API cf_provider_attr_init(cf_attrs_t *attr);
/** Destroys an attribute collection for provider construction
 * @param attr Attribute collection to destroy
 */
cf_rv_t CF_API cf_provider_attr_destroy(cf_attrs_t attr);
 ...
 */
cf_rv_t CF_API cf_provider_attr_set_string(cf_attrs_t attr, cf_attr_id_t id, const char *value);
 ...
 */
cf_rv_t CF_API cf_provider_attr_set_integer(cf_attrs_t attr, cf_attr_id_t id, int value);
 ...
 */
cf_rv_t CF_API cf_provider_attr_find_id(cf_provider_t provider, const char *name, cf_attr_id_t *id);

/** Returns a NULL-name terminated array of named attribute identifiers */
struct cf_named_attr_id CF_API *cf_provider_attr_get_ids(cf_provider_t provider);
/** Release resources allocated for listing named attribute identifiers
 * @param id_list List of identifiers to release
 */
void CF_API cf_provider_attr_destroy_ids(cf_provider_t provider, struct cf_named_attr_id *id_list);
 ...
 */
cf_rv_t CF_API cf_provider_init(cf_provider_t *provider, const cf_attrs_t attrs, const char *path);
 ...
 */
cf_rv_t CF_API cf_provider_destroy(cf_provider_t provider);
